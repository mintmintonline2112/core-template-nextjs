...
export function QuoteForm({ section }: SectionProps) {
  ...
  return (
    <section
      className={cn(
        SECTION,
        "relative overflow-hidden bg-[radial-gradient(120%_90%_at_90%_100%,rgba(37,55,94,.5)_0%,rgba(20,31,56,0)_55%),linear-gradient(160deg,var(--navy-900)_0%,var(--navy-800)_100%)] text-light before:pointer-events-none before:absolute before:inset-0 before:bg-[url('/images/almonds-table.webp')] before:bg-cover before:bg-center before:opacity-[0.14] before:content-['']",
      )}
