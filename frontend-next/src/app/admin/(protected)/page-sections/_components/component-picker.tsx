...
const SKETCHES: Record<string, ReactNode> = {
  ...
  numberedList: <>{box(8, 14, 34, 7, C.ink)}{box(8, 26, 30, 3, C.soft)}{box(8, 32, 26, 3, C.soft)}{box(8, 44, 22, 7, C.line, 2)}{box(52, 16, 8, 5, C.gold, 1)}{box(63, 17, 22, 3, C.ink)}{box(52, 25, 30, 1, C.line, 0)}{box(88, 16, 8, 5, C.gold, 1)}{box(99, 17, 14, 3, C.ink)}{box(52, 31, 8, 5, C.gold, 1)}{box(63, 32, 20, 3, C.ink)}{box(52, 40, 30, 1, C.line, 0)}{box(88, 31, 8, 5, C.gold, 1)}{box(99, 32, 13, 3, C.ink)}{box(52, 46, 8, 5, C.gold, 1)}{box(63, 47, 24, 3, C.ink)}{box(52, 55, 30, 1, C.line, 0)}{box(88, 46, 8, 5, C.gold, 1)}{box(99, 47, 12, 3, C.ink)}</>,
  specSheet: <>{box(30, 6, 48, 6, C.ink)}{box(38, 15, 32, 3, C.soft)}{box(8, 24, 70, 40, '#FFFFFF', 3)}{dot(15, 30, 3, C.gold)}{box(21, 29, 16, 3, C.ink)}{box(42, 29, 32, 3, C.soft)}{box(8, 35, 70, 7, C.line, 0)}{dot(15, 38.5, 3, C.gold)}{box(21, 37, 16, 3, C.ink)}{box(42, 37, 26, 3, C.soft)}{dot(15, 48, 3, C.gold)}{box(21, 47, 16, 3, C.ink)}{box(42, 47, 30, 3, C.soft)}{box(8, 53, 70, 7, C.line, 0)}{dot(15, 56.5, 3, C.gold)}{box(21, 55, 16, 3, C.ink)}{box(42, 55, 22, 3, C.soft)}{box(84, 24, 28, 40, C.line, 3)}{dot(86, 62, 6, C.gold)}</>,
  mediaTabs: <>{box(8, 12, 22, 3, C.gold, 1.5)}{box(36, 12, 22, 3, C.soft, 1.5)}{box(64, 12, 22, 3, C.soft, 1.5)}{box(92, 12, 20, 3, C.soft, 1.5)}{box(8, 17, 104, 1, C.line, 0)}{box(8, 24, 48, 40, C.line, 3)}{box(64, 26, 44, 7, C.ink)}{box(64, 37, 36, 4, C.soft)}{box(64, 45, 44, 3, C.line)}{box(64, 51, 40, 3, C.line)}{box(64, 57, 22, 7, C.ink, 1)}</>,
  photoSlider: <>{box(20, 12, 24, 30, C.line, 3)}{box(48, 12, 24, 30, C.line, 3)}{box(76, 12, 24, 30, C.line, 3)}{dot(10, 27, 5, C.ink)}{dot(110, 27, 5, C.ink)}{box(23, 46, 18, 4, C.soft)}{box(51, 46, 18, 4, C.soft)}{box(79, 46, 18, 4, C.soft)}{box(50, 56, 8, 3, C.gold, 1.5)}{dot(63, 57.5, 1.5, C.soft)}{dot(69, 57.5, 1.5, C.soft)}{box(44, 63, 32, 5, C.ink, 2.5)}</>,
